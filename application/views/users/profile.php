            ...
            <div class="col-lg-10 col-md-10 col-sm-10">
                <div class="box">
                    ...
                    <div class="form-akun-info p-2 pt-3">
                        <?= form_open_multipart('users/profile/update-profile'); ?>
                ...
                <div class="box">
                    <div class="form-update-sandi pt-3">
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            <p><?= $get_sesi_user['name']; ?>, password kamu di perbarui pada <b><?= date('d M Y', $get_sesi_user['password_update']); ?></b></em></p>
                        </div>
                        <?= form_open('users/profle/update-password'); ?>
                        <div class="form-group row">
