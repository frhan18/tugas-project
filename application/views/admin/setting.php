                    ...
                    <div class="row ">
                        <div class="col mb-3">
                            <div class="akun-info-profil mb-3">
                                ...
                                <img src="<?= base_url('upload/' . $get_sesi_user['image']); ?>" class="img-fluid img-thumbnail" width="350" style="max-width: 100%;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 col-sm-10 col-md-10">
                            <div class="form-akun-info p-2 pt-3">
                                <?= form_open_multipart('setting-profile/update-profile/' . $get_sesi_user['id_user']); ?>
        ...
        <div class="row">
            <div class="col">
                <div class="box">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-xl-8 col-sm-10">
                            <div class="form-update-sandi pt-3">
                                ...
                                <hr class="sidebar-divider">
                                <?= form_open('setting-profile/update-password/' . $get_sesi_user['id_user']); ?>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control <?= form_error('password_baru') ? 'is-invalid' : ''; ?>" value="<?= htmlentities(set_value('password_baru')); ?>" name="password_baru" id="password_baru" required minlength="6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control <?= form_error('ulangi_password') ? 'is-invalid' : ''; ?>" value="<?= htmlentities(set_value('ulangi_password')); ?>" name="ulangi_password" id="ulangi_password" required minlength="6">
