...
<nav class="navbar navbar-expand-sm navbar-light">
    <div class="container">
        <a class="navbar-brand" href="index.html"><i class='uil uil-user'></i> SIA APP</a>
...
<?php if ($this->session->flashdata('message_success')) : ?>
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <div class="container">
            Pesan berhasil dikirim, Mohon menunggu pihak admin membalas pesan kamu.
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                <div class="about-text">
                    ...
                    <h1 class="animated animated-text">
                        <span class="mr-2">Selamat datang di aplikasi SIA APP</span>
                    ...
                    <div class="custom-btn-group mt-4">
                        <a href="<?= base_url('/login'); ?>" class="btn custom-btn custom-btn-bg custom-btn-link">Akses Now!</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-md-12 col-12">
                <div class="about-image svg">
                    <img src="<?= base_url('assets/'); ?>images/undraw/undraw_software_engineer_lvl5.svg" class="img-fluid" alt="svg image">
                </div>
            </div>
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="project-info">
                            <img src="<?= base_url('assets/'); ?>images/project/project-image01.png" class="img-fluid" alt="project image">
                        </div>
                    </div>

                    <div class="item">
                        <div class="project-info">
                            <img src="<?= base_url('assets/'); ?>images/project/project-image02.png" class="img-fluid" alt="project image">
                        </div>
                    </div>

                    <div class="item">
                        <div class="project-info">
                            <img src="<?= base_url('assets/'); ?>images/project/project-image03.png" class="img-fluid" alt="project image">
                        </div>
                    </div>

                    <div class="item">
                        <div class="project-info">
                            <img src="<?= base_url('assets/'); ?>images/project/project-image04.png" class="img-fluid" alt="project image">
                        </div>
                    </div>

                    <div class="item">
                        <div class="project-info">
                            <img src="<?= base_url('assets/'); ?>images/project/project-image05.png" class="img-fluid" alt="project image">
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="contact-form">
                    <h2 class="mb-4">Ada yang bisa kami bantu?Hubungi sekarang</h2>
                    ...
                    <form action="" method="get">
                        <div class="row">
                            ...
                            <div class="ml-lg-auto col-lg-5 col-12">
                                ...
                                <button type="submit" class="form-control submit-btn">Kirimkan</button>
                            </div>
                        </div>
                    </form>
                </div>
